...
import com.talhayurt.yemekkitabi.databinding.FragmentTarifBinding
...
class TarifFragment : Fragment() {
    ...
    private fun handleResponse(tarif: Tarif) {
        ...
        binding.yemekText.setText(tarif.isim)
    ...
    fun kaydet(view: View) {
        ...
        val isim = binding.yemekText.text.toString()
        ...
        if (secilenBitmap != null) {
            ...
            val tarif = Tarif(isim = isim,malzeme=malzeme,gorsel=byteDizisi/*isim = isim, malzeme = malzeme, gorsel = byteDizisi*/ );
